...
BODY_PORT = 12000   # ROMP body joint
...
# 성능 최적화 옵션
SHOW_WINDOW = False        # 화면 표시 여부
ENABLE_CONSOLE_LOG = False  # 터미널 출력 여부

PRINT_INTERVAL = 0.3        # 콘솔 출력 주기
HEAD_SEND_INTERVAL = 0.033  # head 송신 주기 (약 30 FPS)
FACE_DETECT_INTERVAL = 0.05 # 얼굴 추적 주기 (약 20 FPS)
FACE_SCALE = 0.5            # 얼굴 추적 입력 축소 비율
